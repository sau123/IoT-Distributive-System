app.controller('LocationController', function($scope, $http, $location) { 
	...
	$scope.processForm = function(){
		...
		}, "<p style='text-decoration:underline'>HOME</p><h3 style='color:black'>Air Conditioner</h3>");

		var marker1 = createMarker({
			position: new google.maps.LatLng(37.3254377,-121.8848723),
			map: map
		}, "<p style='text-decoration:underline'>HOME</p><h3 style='color:black'>Refrigerator</h3>");

		var marker2 = createMarker({
			position: new google.maps.LatLng(37.3364377,-121.8809723),
			map: map
		}, "<p style='text-decoration:underline'>OFFICE</p><h3 style='color:black ; text-3'>Thermostat</h3>");
//		});
